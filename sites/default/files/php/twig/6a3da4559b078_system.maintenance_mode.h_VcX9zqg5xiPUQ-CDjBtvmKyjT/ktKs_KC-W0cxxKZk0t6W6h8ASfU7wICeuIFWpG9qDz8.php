...
class __TwigTemplate_c63d08829387bbb4ea92ae8a1daffdc2 extends Template
{
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 7 %}{% set cache_topic = render_var(help_topic_link(\x27system.cache\x27)) %}
{% set maintenance_link_text %}{% trans %}Maintenance mode{% endtrans %}{% endset %}
{% set maintenance_link = render_var(help_route_link(maintenance_link_text, \x27system.site_maintenance_mode\x27)) %}
...
</ol>", "@help_topics/system.maintenance_mode.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\system\\help_topics\\system.maintenance_mode.html.twig");
    }
