...
class __TwigTemplate_f73968d702d4bb12335995d94328b023 extends Template
{
...
<dl>
  ...
  <dd>{% trans %}The configuration sync directory location is set in the site\x27s <em>settings.php</em> file. When configuration is exported, the active configuration is exported and described in YAML files which are stored in the configuration sync directory. After the first export, the system compares the site\x27s active configuration with the configuration data in the sync directory and will only export active configuration items that are different than their counterparts in the sync directory.{% endtrans %}</dd>
</dl>
...
</ul>", "@help_topics/core.config_overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\help\\help_topics\\core.config_overview.html.twig");
    }
