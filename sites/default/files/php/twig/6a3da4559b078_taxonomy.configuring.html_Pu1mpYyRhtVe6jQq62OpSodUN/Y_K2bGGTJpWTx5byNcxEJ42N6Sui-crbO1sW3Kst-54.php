...
class __TwigTemplate_ea9f6f52d35117f22b691f6d433cd7b3 extends Template
{
...
{% endset %}
{% set taxonomy_permissions_link = render_var(help_route_link(taxonomy_permissions_link_text, \x27user.admin_permissions.module\x27, {\x27modules\x27: \x27taxonomy\x27})) %}
{% set taxonomy_admin_link_text %}
  {% trans %}Taxonomy{% endtrans %}
{% endset %}
{% set taxonomy_admin_link = render_var(help_route_link(taxonomy_admin_link_text, \x27entity.taxonomy_vocabulary.collection\x27)) %}
{% set taxonomy_overview_topic = render_var(help_topic_link(\x27taxonomy.overview\x27)) %}
...
</ul>", "@help_topics/taxonomy.configuring.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\taxonomy\\help_topics\\taxonomy.configuring.html.twig");
    }
