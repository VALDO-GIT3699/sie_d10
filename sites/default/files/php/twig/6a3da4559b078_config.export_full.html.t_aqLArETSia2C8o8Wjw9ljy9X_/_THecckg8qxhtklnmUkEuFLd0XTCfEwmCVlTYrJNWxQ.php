...
class __TwigTemplate_a643932024abcad6742c6815bdf2d486 extends Template
{
...
{% set export_link = render_var(help_route_link(export_link_text, \x27config.export_full\x27)) %}
{% set config_overview_topic = render_var(help_topic_link(\x27core.config_overview\x27)) %}
<h2>{% trans %}Goal{% endtrans %}</h2>
<p>{% trans %}Create and download an archive containing all your site\x27s configuration, exported as YAML files. See {{ config_overview_topic }} for more information about configuration.{% endtrans %}</p>
...
</ol>", "@help_topics/config.export_full.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\config\\help_topics\\config.export_full.html.twig");
    }
