...
class __TwigTemplate_8c06dd89dc9e64f5a4d76e35625892ec extends Template
{
...
<p>{% trans %}Breakpoints are the point at which your site\x27s content will respond to provide the user with the best possible layout to consume the information. A breakpoint separates the height or width of viewports (screens, printers, and other media output types) into steps. For instance, a width breakpoint of 40em creates two steps: one for widths up to 40em and one for widths above 40em. Breakpoints can be used to define when layouts should shift from one form to another, when images should be resized, and other changes that need to respond to changes in viewport height or width.{% endtrans %}</p>
...
</ul>", "@help_topics/breakpoint.overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\breakpoint\\help_topics\\breakpoint.overview.html.twig");
    }
