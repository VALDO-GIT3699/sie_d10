...
class __TwigTemplate_f6abcf1550b197ad1aae2bc5361389db extends Template
{
...
{% endset %}
{% set comment_permissions_link = render_var(help_route_link(comment_permissions_link_text, \x27user.admin_permissions.module\x27, {\x27modules\x27: \x27comment\x27})) %}
{% set content_structure_topic = render_var(help_topic_link(\x27core.content_structure\x27)) %}
{% set comment_type_topic = render_var(help_topic_link(\x27comment.creating_type\x27)) %}
...
<ol>
  ...
  <li>{% trans %}On the first field settings page, choose the <em>Comment type</em> to use for this entity type or sub-type. You\x27ll also notice that the <em>Allowed number of values</em> field cannot be changed for comment fields.{% endtrans %}</li>
...
</ul>", "@help_topics/comment.configuring.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\comment\\help_topics\\comment.configuring.html.twig");
    }
