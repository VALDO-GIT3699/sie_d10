...
class __TwigTemplate_606d21c896545190f5f5a16ffa2c050f extends Template
{
...
<p>";
    ...
    {
        return new Source("{% line 7 %}{% set accessibility_topic = render_var(help_topic_link(\x27core.ui_accessibility\x27)) %}
{% set settings_tray_topic = render_var(help_topic_link(\x27core.settings_tray\x27)) %}
{% set admin_link = render_var(help_route_link(\x27/admin\x27, \x27system.admin\x27)) %}
