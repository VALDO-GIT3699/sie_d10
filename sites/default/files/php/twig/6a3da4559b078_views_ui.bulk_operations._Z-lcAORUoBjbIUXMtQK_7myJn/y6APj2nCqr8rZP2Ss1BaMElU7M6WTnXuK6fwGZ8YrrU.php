...
class __TwigTemplate_be89c28b1c1b40ed596b28c7cbf2ee46 extends Template
{
...
{% endset %}
{% set views = render_var(help_route_link(views_link_text, \x27entity.view.collection\x27)) %}
{% set views_permissions_link_text %}
  {% trans %}Administer views{% endtrans %}
{% endset %}
{% set views_permissions = render_var(help_route_link(views_permissions_link_text, \x27user.admin_permissions.module\x27, {\x27modules\x27: \x27views_ui\x27})) %}
...
<ol>
  ...
  <li>{% trans %}Verify that the <em>Access</em> settings for the view are at least as restrictive as the permissions necessary to perform the bulk operations. People with permission to see the view, but who don\x27t have permission to do the bulk operations, will experience problems.{% endtrans %}</li>
  <li>{% trans %}Click <em>Save</em>. The action(s) will be available as bulk operations in the view.{% endtrans %}</li>
</ol>", "@help_topics/views_ui.bulk_operations.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\views_ui\\help_topics\\views_ui.bulk_operations.html.twig");
    }
