...
class __TwigTemplate_09fc2bcae526f10334d6210c7696e1dd extends Template
{
...
{% endset %}
{% set path_permissions_link = render_var(help_route_link(path_permissions_link_text, \x27user.admin_permissions.module\x27, {\x27modules\x27: \x27path\x27})) %}
{% set path_aliases_link_text %}
  {% trans %}URL aliases{% endtrans %}
{% endset %}
{% set path_aliases_link = render_var(help_route_link(path_aliases_link_text, \x27entity.path_alias.collection\x27)) %}
{% set path_overview_topic = render_var(help_topic_link(\x27path.overview\x27)) %}
...
<ol>
  <li>{% trans %}In the <em>Manage</em> administration menu, navigate to <em>Configuration</em> &gt; <em>Search and metadata</em> &gt; <em>{{ path_aliases_link }}</em>. A list of all the site\x27s aliases will appear.{% endtrans %}</li>
...
</ol>", "@help_topics/path.editing_alias.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\path\\help_topics\\path.editing_alias.html.twig");
    }
