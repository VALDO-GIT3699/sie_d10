...
class __TwigTemplate_66d527104a98454513844915f2d3493a extends Template
{
...
{% set regional_link = render_var(help_route_link(regional_link_text, \x27system.regional_settings\x27)) %}
{% set information_link_text %}{% trans %}Basic site settings{% endtrans %}{% endset %}
{% set information_link = render_var(help_route_link(information_link_text, \x27system.site_information_settings\x27)) %}
{% set datetime_link_text %}{% trans %}Date and time formats{% endtrans %}{% endset %}
{% set datetime_link = render_var(help_route_link(datetime_link_text, \x27entity.date_format.collection\x27)) %}
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\system\\help_topics\\system.config_basic.html.twig");
    }
