...
class __TwigTemplate_b594db96161568f4dda7534005dbb741 extends Template
{
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 8 %}{% set media_topic = render_var(help_topic_link(\x27core.media\x27)) %}
{% set styles_text %}{% trans %}Image styles{% endtrans %}{% endset %}
{% set styles_link = render_var(help_route_link(styles_text, \x27entity.image_style.collection\x27)) %}
...
</ol>", "@help_topics/image.style.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\image\\help_topics\\image.style.html.twig");
    }
