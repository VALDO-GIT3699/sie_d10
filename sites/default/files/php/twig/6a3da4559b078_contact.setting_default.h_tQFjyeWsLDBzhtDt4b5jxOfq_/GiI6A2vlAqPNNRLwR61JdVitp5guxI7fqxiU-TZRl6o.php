...
class __TwigTemplate_d6c458d9f49425b5912e33a928d7cd1f extends Template
{
...
{% set contact_link = render_var(help_route_link(contact_link_text, \x27entity.contact_form.collection\x27)) %}
{% set contact_page_link_text %}{% trans %}the form displayed on the default contact page{% endtrans %}{% endset %}
{% set contact_page_link = render_var(help_route_link(contact_page_link_text, \x27contact.site_page\x27)) %}
...
</ol>", "@help_topics/contact.setting_default.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\contact\\help_topics\\contact.setting_default.html.twig");
    }
