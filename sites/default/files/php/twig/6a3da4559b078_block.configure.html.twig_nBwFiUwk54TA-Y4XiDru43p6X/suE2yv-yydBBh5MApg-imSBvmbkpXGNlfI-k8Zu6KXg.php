...
class __TwigTemplate_3c1e912630db6d029037e4ab04f7c5c9 extends Template
{
...
{% set layout_link = render_var(help_route_link(layout_link_text, \x27block.admin_display\x27)) %}
...
<li>{% trans %}If you want to change additional settings, find the region where the block you want to update is currently located, and click <em>Configure</em> in the line of the block description.{% endtrans %}</li>
  <li>{% trans %}Edit the block\x27s settings. The available settings vary depending on the module that provides the block, but for all blocks you can change:{% endtrans %}
    <ul>
...
</ol>", "@help_topics/block.configure.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\block\\help_topics\\block.configure.html.twig");
    }
