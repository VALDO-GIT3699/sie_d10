...
class __TwigTemplate_771b2712eb7d929a5bc182d0971ed829 extends Template
{
...
{% set people_link = render_var(help_route_link(people_link_text, \x27entity.user.collection\x27)) %}
...
<ol>
  ...
  <li>{% trans %}To delete the user account, scroll to the bottom and click <em>Cancel account</em>. Select what you want to happen to the user\x27s content on the next screen, and click <em>Cancel account</em>.{% endtrans %}</li>
  <li>{% trans %}To update the user account, enter new values in the form and click <em>Save</em>.{% endtrans %}</li>
</ol>", "@help_topics/user.update.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\user\\help_topics\\user.update.html.twig");
    }
