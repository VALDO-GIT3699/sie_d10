...
class __TwigTemplate_59a954665423e6c43c49459cb22b4bda extends Template
{
...
<p>";
    ...
    {
        return new Source("{% line 8 %}{% set config_overview_topic = render_var(help_topic_link(\x27core.config_overview\x27)) %}
...
<ul>
  ...
  <li>{% trans %}Many configuration items also include text that can be translated. Default configuration provided by your site\x27s software is provided in English; you can also download community-provided translations. See {{ config_overview_topic }} to learn more about configuration.{% endtrans %}</li>
