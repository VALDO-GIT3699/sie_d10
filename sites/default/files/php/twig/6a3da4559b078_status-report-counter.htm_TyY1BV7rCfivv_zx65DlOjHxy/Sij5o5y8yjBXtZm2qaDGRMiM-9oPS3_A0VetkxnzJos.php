...
class __TwigTemplate_4caa3aa8d7dfdd206c254375d40342bd extends Template
{
...
{%
  set classes = [
    \x27system-status-counter\x27,
    \x27system-status-counter--\x27 ~ severity,
  ]
%}
<span{{ attributes.addClass(classes) }}>
  ...
  <span class=\"system-status-counter__status-title\">
    ...
    <span class=\"system-status-counter__details\"><a href=\"#{{ severity }}\" ><span class=\"visually-hidden\">{{ text }} </span>{{ \x27Details\x27|t }}</a></span>
  </span>
</span>
", "core/themes/claro/templates/status-report-counter.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\themes\\claro\\templates\\status-report-counter.html.twig");
    }
