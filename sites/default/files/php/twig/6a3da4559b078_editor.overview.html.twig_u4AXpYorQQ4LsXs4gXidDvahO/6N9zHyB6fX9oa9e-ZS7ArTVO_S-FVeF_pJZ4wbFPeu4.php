...
class __TwigTemplate_fb961c5f9d1a0927080bfd2a39c1112c extends Template
{
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 8 %}{% set filter_overview_topic = render_var(help_topic_link(\x27filter.overview\x27)) %}
{% set overview_link_text %}{% trans %}Text formats and editors{% endtrans %}{% endset %}
{% set overview_link = render_var(help_route_link(overview_link_text, \x27filter.admin_overview\x27)) %}
...
</ol>", "@help_topics/editor.overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\editor\\help_topics\\editor.overview.html.twig");
    }
