...
class __TwigTemplate_6bb31ada616bfdd379edf0b5d48da09f extends Template
{
...
{% set account_settings_link = render_var(help_route_link(account_settings_link_text, \x27entity.user.admin_form\x27)) %}
...
<ul>
  ...
  <li>{% trans %}[user:display-name]: The user\x27s displayed name.{% endtrans %}</li>
  <li>{% trans %}[user:account-name]: The user\x27s account name.{% endtrans %}</li>
  <li>{% trans %}[user:mail]: The user\x27s email alias.{% endtrans %}</li>
...
</ol>", "@help_topics/user.security_account_settings.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\user\\help_topics\\user.security_account_settings.html.twig");
    }
