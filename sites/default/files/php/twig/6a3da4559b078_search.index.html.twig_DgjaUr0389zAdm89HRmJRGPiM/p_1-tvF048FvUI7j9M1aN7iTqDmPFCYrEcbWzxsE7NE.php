...
class __TwigTemplate_0532dd26264a0e6e1bcc59386fd7ff8d extends Template
{
...
<li>";
    ...
    {
        return new Source("{% line 7 %}{% set cron_topic = render_var(help_topic_link(\x27core.cron\x27)) %}
{% set search_settings_link_text %}{% trans %}Search pages{% endtrans %}{% endset %}
{% set search_settings_link = render_var(help_route_link(search_settings_link_text, \x27entity.search_page.collection\x27)) %}
...
</ol>", "@help_topics/search.index.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\search\\help_topics\\search.index.html.twig");
    }
