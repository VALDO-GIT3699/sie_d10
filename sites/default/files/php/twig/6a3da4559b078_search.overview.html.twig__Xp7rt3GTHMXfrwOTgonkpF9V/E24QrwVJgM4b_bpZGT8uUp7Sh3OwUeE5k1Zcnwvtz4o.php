...
class __TwigTemplate_ad33486caac5bc841db886a84db14b39 extends Template
{
...
{% set search_link = render_var(help_route_link(search_link_text, \x27search.view\x27)) %}
{% set user_overview_topic = render_var(help_topic_link(\x27user.overview\x27)) %}
...
<p>{% trans %}As an alternative to the core Search module\x27s system of search pages, you can use contributed modules to provide site search. For example, the <a href=\"https://www.drupal.org/project/apachesolr\">Apache Solr</a> and <a href=\"https://www.drupal.org/project/sphinx\">Sphinx</a> contributed modules use third-party technology to provide site search.{% endtrans %}</p>
...
</ul>", "@help_topics/search.overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\search\\help_topics\\search.overview.html.twig");
    }
