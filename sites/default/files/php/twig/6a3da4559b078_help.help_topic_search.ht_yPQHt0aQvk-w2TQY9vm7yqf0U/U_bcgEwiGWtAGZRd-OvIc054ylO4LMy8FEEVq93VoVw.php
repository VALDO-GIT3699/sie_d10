...
class __TwigTemplate_53b2f7c5229153a6dd0f156326763f10 extends Template
{
...
{% set extend_link = render_var(help_route_link(extend_link_text, \x27system.modules_list\x27)) %}
{% set help_link = render_var(help_route_link(help_link_text, \x27help.main\x27)) %}
{% set cache_topic = render_var(help_topic_link(\x27system.cache\x27)) %}
{% set cron_topic = render_var(help_topic_link(\x27core.cron\x27)) %}
...
</ol>", "@help_topics/help.help_topic_search.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\help\\help_topics\\help.help_topic_search.html.twig");
    }
