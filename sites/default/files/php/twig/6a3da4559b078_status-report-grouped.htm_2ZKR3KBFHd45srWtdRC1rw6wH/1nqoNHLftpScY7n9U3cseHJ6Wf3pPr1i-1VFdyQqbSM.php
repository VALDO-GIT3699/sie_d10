...
class __TwigTemplate_a635295bcc69fee636d1550068fb0210 extends Template
{
 ...
 *     - value: (optional) The requirement\x27s status.
 *     - description: (optional) The requirement\x27s description.
 *     - severity_title: The title of the severity.
 *     - severity_status: Indicates the severity status.
 */
#}
{{ attach_library(\x27core/drupal.collapse\x27) }}

<div class=\"system-status-report\">
  <h2 class=\"system-status-general-info__header\">{{ \x27Status Details\x27|t }}</h2>
      ...
      <div class=\"claro-details__wrapper claro-details__wrapper--system-status-report\">
        {% for requirement in group.items %}
          <div class=\"system-status-report__row\">
              {%
                set summary_classes = [
                  \x27system-status-report__status-title\x27,
                  group.type in [\x27warning\x27, \x27error\x27] ? \x27system-status-report__status-icon system-status-report__status-icon--\x27 ~ group.type
                ]
              %}
              <div{{ create_attribute({\x27class\x27: summary_classes}) }} role=\"button\">
...
", "core/themes/claro/templates/status-report-grouped.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\themes\\claro\\templates\\status-report-grouped.html.twig");
    }
