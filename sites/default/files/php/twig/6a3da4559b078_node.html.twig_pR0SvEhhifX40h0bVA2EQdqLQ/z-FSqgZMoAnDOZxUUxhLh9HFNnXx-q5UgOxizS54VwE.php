...
class __TwigTemplate_3a66205641b6d3aac8d30ee3b818b450 extends Template
{
...
";
    ...
    {
        return array (  114 => 102,  110 => 101,  107 => 100,  99 => 96,  97 => 95,  93 => 94,  89 => 93,  86 => 92,  84 => 91,  78 => 89,  70 => 86,  65 => 85,  63 => 84,  59 => 83,  54 => 81,  50 => 80,  48 => 77,  47 => 76,  46 => 75,  45 => 74,  44 => 73,  43 => 71,);
    }
 ...
 *   - node.hasField(\x27field_example\x27) returns TRUE if the node bundle includes
 ...
 *   {{ content|without(\x27field_example\x27) }} to temporarily suppress the printing
 ...
 * - teaser: Flag for the teaser state. Will be true if view_mode is \x27teaser\x27.
 * - page: Flag for the full page state. Will be true if view_mode is \x27full\x27.
...
{%
  set classes = [
    \x27node\x27,
    \x27node--type-\x27 ~ node.bundle|clean_class,
    node.isPromoted() ? \x27node--promoted\x27,
    node.isSticky() ? \x27node--sticky\x27,
    not node.isPublished() ? \x27node--unpublished\x27,
    view_mode ? \x27node--view-mode-\x27 ~ view_mode|clean_class,
  ]
%}
{{ attach_library(\x27bootstrap4/node\x27) }}
<article{{ attributes.addClass(classes) }}>
  ...
  {% if display_submitted %}
    <footer class=\"node__meta\">
      {{ author_picture }}
      <div{{ author_attributes.addClass(\x27node__submitted\x27) }}>
  ...
  <div{{ content_attributes.addClass(\x27node__content\x27) }}>
    {{ content }}
  </div>

</article>
", "themes/contrib/bootstrap4/templates/content/node.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\themes\\contrib\\bootstrap4\\templates\\content\\node.html.twig");
    }
