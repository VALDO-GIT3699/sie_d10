...
class __TwigTemplate_b26fb98031191951f3e391c7bb8e7236 extends Template
{
...
{% set uninstall_link = render_var(help_route_link(uninstall_link_text, \x27system.modules_uninstall\x27)) %}
{% set maintenance_topic = render_var(help_topic_link(\x27system.maintenance_mode\x27)) %}
...
<ol>
  ...
  <li>{% trans %}If there are no reasons listed, the module can be uninstalled. Check the box in the <em>Uninstall</em> column, next to the module\x27s name.{% endtrans %}</li>
...
</ol>", "@help_topics/system.module_uninstall.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\system\\help_topics\\system.module_uninstall.html.twig");
    }
