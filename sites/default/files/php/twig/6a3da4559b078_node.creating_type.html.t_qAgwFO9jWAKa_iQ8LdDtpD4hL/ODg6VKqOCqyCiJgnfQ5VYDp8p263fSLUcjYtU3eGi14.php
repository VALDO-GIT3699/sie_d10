...
class __TwigTemplate_da5436901d60689f0455ca2b7a8f5675 extends Template
{
...
{% endset %}
{% set content_permissions_link = render_var(help_route_link(content_permissions_link_text, \x27user.admin_permissions.module\x27, {\x27modules\x27: \x27node\x27})) %}
{% set content_types_link_text %}
  {% trans %}Content types{% endtrans %}
{% endset %}
{% set content_types_link = render_var(help_route_link(content_types_link_text, \x27entity.node_type.collection\x27)) %}
{% set content_overview_topic = render_var(help_topic_link(\x27node.overview\x27)) %}
...
</ul>", "@help_topics/node.creating_type.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\node\\help_topics\\node.creating_type.html.twig");
    }
