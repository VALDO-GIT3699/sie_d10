...
class __TwigTemplate_1d16b145f5e4e75d5698f00923156e52 extends Template
{
...
<ul>
  <li>";
    ...
    {
        return new Source("{% line 11 %}{% set content_structure_topic = render_var(help_topic_link(\x27core.content_structure\x27)) %}
...
<p>{% trans %}An image style is a set of processing steps, known as <em>effects</em>, that can be applied to images. Examples of effects include scaling and cropping images to different sizes. Responsive image styles can associate image styles with your theme\x27s size breakpoints. This allows serving images sized for the browser width.{% endtrans %}</p>
...
</ul>", "@help_topics/core.media.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\help\\help_topics\\core.media.html.twig");
    }
