...
class __TwigTemplate_abe9e96c4072425793032aff5ddb67fa extends Template
{
...
<ul>
  ...
  <li><a href=\"https://www.drupal.org/docs/develop/theming-drupal\">";
    ...
    {
        return new Source("{% line 7 %}{% set content_structure_topic = render_var(help_topic_link(\x27core.content_structure\x27)) %}
...
<p>{% trans %}The main way to change the overall appearance of your site is to switch the default theme. The core Layout Builder and Layout Discovery modules allow you to define layouts for your site\x27s content, and the core Breakpoint module helps themes change appearance for different-sized devices. See the related topics listed below for specific tasks.{% endtrans %}</p>
...
</ul>", "@help_topics/core.appearance.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\help\\help_topics\\core.appearance.html.twig");
    }
