...
class __TwigTemplate_9fe62710dd4525c75c38f09454ce5b4d extends Template
{
...
{% endset %}
{% set comment_unpublished_link = render_var(help_route_link(comment_unpublished_link_text, \x27comment.admin_approval\x27)) %}
{% set comment_published_link_text %}
  {% trans %}Comments{% endtrans %}
{% endset %}
{% set comment_published_link = render_var(help_route_link(comment_published_link_text, \x27comment.admin\x27)) %}
...
</ul>", "@help_topics/comment.moderating.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\comment\\help_topics\\comment.moderating.html.twig");
    }
