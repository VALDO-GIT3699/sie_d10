...
class __TwigTemplate_ae0e0b8a44fc937d474f1ca350b8e159 extends Template
{
...
<p>{% trans %}The core User module allows users to register, log in, and log out, and administrators to manage user roles and permissions. The core Ban module allows administrators to ban certain IP addresses from accessing the site. Depending on which modules you have installed on your site, the related topics below will help you with tasks related to managing user accounts and visitors.{% endtrans %}</p>", "@help_topics/user.overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\user\\help_topics\\user.overview.html.twig");
    }
