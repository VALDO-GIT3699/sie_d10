...
class __TwigTemplate_c4c9ccbf3ea5edef435e9b811999e802 extends Template
{
...
<p>";
    ...
    {
        return new Source("{% line 13 %}{% set content_structure_topic = render_var(help_topic_link(\x27core.content_structure\x27)) %}
{% set users_overview_topic = render_var(help_topic_link(\x27user.overview\x27)) %}
...
<p>{% trans %}See the related topics listed below for specific tasks.{% endtrans %}</p>", "@help_topics/comment.overview.html.twig", "C:\\xampp8.2.12\\htdocs\\sie_d10\\core\\modules\\comment\\help_topics\\comment.overview.html.twig");
    }
